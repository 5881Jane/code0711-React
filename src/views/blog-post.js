...
const BlogPost = (props) => {
  return (
    <div className="blog-post-container">
      <Helmet>
        <title>BlogPost - code0711</title>
        <meta property="og:title" content="BlogPost - code0711" />
      </Helmet>
      ...
      <div className="blog-post-post-details">
        ...
        <span className="blog-post-text textXL">posted 18 Sept 2021</span>
        <span className="blog-post-text01">
          ...
          <span className="blog-post-text04">Mark Jonson</span>
          <br></br>
        </span>
        <span className="blog-post-text05">
      ...
      <div className="blog-post-container02">
        <div className="blog-post-story">
          <span className="blog-post-text07 textLG">
            <span>March 1, 2019</span>
          </span>
          <h3 className="blog-post-text09 text2XL">
            The Castle Looks Different at Night...
          </h3>
          <span className="blog-post-text10 textLG">
            <span className="blog-post-text11">
          ...
          <div className="blog-post-container03">
            <span className="textLG">
              <span className="blog-post-text16">&quot;</span>
              <span className="blog-post-text17">
                And thank you for turning my personal jean jacket into a couture
                piece.
              </span>
              <span className="blog-post-text18">&quot;</span>
            </span>
            <span className="blog-post-text19">
              <span className="blog-post-text20">Kanye West, Producer.</span>
              <span className="blog-post-text21"></span>
            </span>
          </div>
          <h3 className="blog-post-text22 text2XL">
            Using Video Games To Generate Clicks
          </h3>
          <span className="blog-post-text23 textLG">
            <span className="blog-post-text24">
              This is the paragraph where you can write more details about your
              product. Keep you user engaged by providing meaningful
              information. Remember that by this time, the user is curious,
              otherwise he wouldn&apos;t scroll to get here. Add a button if you
          ...
          />
          <h3 className="blog-post-text25 text2XL">Rest of the Story</h3>
          <span className="blog-post-text26 textLG">
            <span className="blog-post-text27">
            ...
            <span></span>
            <br></br>
            <span className="blog-post-text33">
          ...
          <div className="blog-post-post">
            <span className="blog-post-text34 textXL">What people say...</span>
            ...
            <div className="blog-post-container04">
              <div className="blog-post-container05">
                ...
                <div className="blog-post-container06">
                  <span className="blog-post-text35 textSM">JOHN SNOW</span>
                  <div className="blog-post-container07">
                    <span className="blog-post-text36 textXS">3 days ago</span>
                  </div>
                </div>
              </div>
              <SecondaryButton button="FOLLOW"></SecondaryButton>
            </div>
            <span className="blog-post-text37 textMD">
            ...
            <div className="blog-post-container08">
              <div className="blog-post-container09">
                ...
                <span className="blog-post-text39 textXS">150</span>
                ...
                <span className="blog-post-text40 textXS">36</span>
                ...
                <span className="blog-post-text41 textXS">12</span>
              </div>
              <div className="blog-post-container10">
                ...
                />
                <span className="blog-post-text42 textXS">and 30+ more</span>
              </div>
            </div>
            <div className="blog-post-divider1"></div>
            <span className="blog-post-text43 textSM">Load previous</span>
            <PostReaction
              name="Michael Lewis"
              likes="3"
            ...
            ></PostReaction>
            <span className="blog-post-text44 textSM">Load next</span>
      ...
      <div className="blog-post-posts">
        <div className="blog-post-container12">
          ...
          <h3 className="blog-post-text45 healine">
            <span className="blog-post-text46">Before I go </span>
          </h3>
          <span className="blog-post-text47 textXL">
